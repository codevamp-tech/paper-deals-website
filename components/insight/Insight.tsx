    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="hidden md:block absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-[#543792] to-transparent z-10"></div>
          <div className="hidden md:block absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-[#543792] to-transparent z-10"></div>
