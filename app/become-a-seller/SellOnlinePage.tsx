    ...
    <div className="min-h-screen  font-sans">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0 space-y-6 animate-fadeInUp">
            ...
            <div className="flex space-x-4">
              <Link href="/SellerPage">
                {" "}
                <button className="bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 text-white font-medium py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                  Start Selling
                </button>
              </Link>
      ...
      <section className=" py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="bg-white text-blue-600 font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl ">
