      ...
      <div className="bg-gradient-to-br from-white/90 via-white/80 to-white/90 shadow-2xl rounded-3xl w-full max-w-lg p-10 border border-white/30 backdrop-blur-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col">
            <label className="text-purple-800 font-medium mb-2">New Password</label>
            <input
              type="password"
              value={newPassword}
          ...
          {/* Confirm Password */}
          <div className="flex flex-col">
            <label className="text-purple-800 font-medium mb-2">Confirm Password</label>
            <input
              type="password"
          ...
          <button
            ...
            className={`mt-4 w-full py-3 rounded-xl text-white font-semibold transition shadow-lg
              ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-purple-700 to-sky-200 hover:opacity-90"}`}
          >
