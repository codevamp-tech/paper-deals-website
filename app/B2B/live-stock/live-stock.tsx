    ...
    <>
      <main className="w-full min-h-screen bg-[#fafafa] px-4 sm:px-6 lg:px-8">
        ...
        <section className="relative border-b border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-3 md:py-2">
            {/* Badge */}
            ...
            <div className="text-center ">
              <h1 className={`${theme.Text} text-[6vh] font-[900] mt-1 font-[Poppins] flex justify-center`}>
                Live Stock
              </h1>
